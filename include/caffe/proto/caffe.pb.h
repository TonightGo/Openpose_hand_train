...
enum CPMDataParameter_DB {
  CPMDataParameter_DB_LEVELDB = 0,
  CPMDataParameter_DB_LMDB = 1
};
bool CPMDataParameter_DB_IsValid(int value);
const CPMDataParameter_DB CPMDataParameter_DB_DB_MIN = CPMDataParameter_DB_LEVELDB;
const CPMDataParameter_DB CPMDataParameter_DB_DB_MAX = CPMDataParameter_DB_LMDB;
const int CPMDataParameter_DB_DB_ARRAYSIZE = CPMDataParameter_DB_DB_MAX + 1;

const ::google::protobuf::EnumDescriptor* CPMDataParameter_DB_descriptor();
inline const ::std::string& CPMDataParameter_DB_Name(CPMDataParameter_DB value) {
  return ::google::protobuf::internal::NameOfEnum(
    CPMDataParameter_DB_descriptor(), value);
}
inline bool CPMDataParameter_DB_Parse(
    const ::std::string& name, CPMDataParameter_DB* value) {
  return ::google::protobuf::internal::ParseNamedEnum<CPMDataParameter_DB>(
    CPMDataParameter_DB_descriptor(), name, value);
}
enum Phase {
  TRAIN = 0,
  TEST = 1
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.CPMDataParameter cpmdata_param = 999;
  inline bool has_cpmdata_param() const;
  inline void clear_cpmdata_param();
  static const int kCpmdataParamFieldNumber = 999;
  inline const ::caffe::CPMDataParameter& cpmdata_param() const;
  inline ::caffe::CPMDataParameter* mutable_cpmdata_param();
  inline ::caffe::CPMDataParameter* release_cpmdata_param();
  inline void set_allocated_cpmdata_param(::caffe::CPMDataParameter* cpmdata_param);
 ...
 private:
  ...
  inline void set_has_cpmdata_param();
  inline void clear_has_cpmdata_param();
  ...
  ::caffe::CPMDataParameter* cpmdata_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_src_2fcaffe_2fproto_2fcaffe_2eproto();
  friend void protobuf_AssignDesc_src_2fcaffe_2fproto_2fcaffe_2eproto();
...
class TransformationParameter : public ::google::protobuf::Message {
 public:
  ...
  static const int kScaleCvgFieldNumber = 7;
  ...
  static const int kMaxCvgLenFieldNumber = 8;
  ...
  static const int kMinCvgLenFieldNumber = 9;
  ...
  inline bool has_opaque_coverage() const;
  inline void clear_opaque_coverage();
  static const int kOpaqueCoverageFieldNumber = 10;
  inline bool opaque_coverage() const;
  inline void set_opaque_coverage(bool value);

  // optional string coverage = 11 [default = "gridbox_max"];
  inline bool has_coverage() const;
  inline void clear_coverage();
  static const int kCoverageFieldNumber = 11;
  inline const ::std::string& coverage() const;
  inline void set_coverage(const ::std::string& value);
  inline void set_coverage(const char* value);
  inline void set_coverage(const char* value, size_t size);
  inline ::std::string* mutable_coverage();
  inline ::std::string* release_coverage();
  inline void set_allocated_coverage(::std::string* coverage);

  // optional float flip_prob = 12 [default = 0.5];
  inline bool has_flip_prob() const;
  inline void clear_flip_prob();
  static const int kFlipProbFieldNumber = 12;
  inline float flip_prob() const;
  inline void set_flip_prob(float value);

  // optional float max_rotate_degree = 13 [default = 5];
  inline bool has_max_rotate_degree() const;
  inline void clear_max_rotate_degree();
  static const int kMaxRotateDegreeFieldNumber = 13;
  ...
  static const int kVisualizeFieldNumber = 14;
  inline bool visualize() const;
  inline void set_visualize(bool value);

  // optional uint32 crop_size_x = 15 [default = 368];
  inline bool has_crop_size_x() const;
  inline void clear_crop_size_x();
  static const int kCropSizeXFieldNumber = 15;
  inline ::google::protobuf::uint32 crop_size_x() const;
  inline void set_crop_size_x(::google::protobuf::uint32 value);

  // optional uint32 crop_size_y = 16 [default = 368];
  inline bool has_crop_size_y() const;
  inline void clear_crop_size_y();
  static const int kCropSizeYFieldNumber = 16;
  inline ::google::protobuf::uint32 crop_size_y() const;
  inline void set_crop_size_y(::google::protobuf::uint32 value);

  // optional float scale_prob = 17 [default = 0.5];
  inline bool has_scale_prob() const;
  inline void clear_scale_prob();
  static const int kScaleProbFieldNumber = 17;
  ...
  static const int kScaleMinFieldNumber = 18;
  ...
  static const int kScaleMaxFieldNumber = 19;
  inline float scale_max() const;
  inline void set_scale_max(float value);

  // optional float bbox_norm_factor = 20 [default = 300];
  inline bool has_bbox_norm_factor() const;
  inline void clear_bbox_norm_factor();
  static const int kBboxNormFactorFieldNumber = 20;
  inline float bbox_norm_factor() const;
  inline void set_bbox_norm_factor(float value);

  // optional string img_header = 21 [default = "."];
  inline bool has_img_header() const;
  inline void clear_img_header();
  static const int kImgHeaderFieldNumber = 21;
  inline const ::std::string& img_header() const;
  inline void set_img_header(const ::std::string& value);
  inline void set_img_header(const char* value);
  inline void set_img_header(const char* value, size_t size);
  inline ::std::string* mutable_img_header();
  inline ::std::string* release_img_header();
  inline void set_allocated_img_header(::std::string* img_header);

  // optional bool force_color = 22 [default = false];
  inline bool has_force_color() const;
  inline void clear_force_color();
  static const int kForceColorFieldNumber = 22;
  ...
  static const int kForceGrayFieldNumber = 23;
  inline bool force_gray() const;
  inline void set_force_gray(bool value);

  // optional float target_dist = 24 [default = 1];
  inline bool has_target_dist() const;
  inline void clear_target_dist();
  static const int kTargetDistFieldNumber = 24;
  inline float target_dist() const;
  inline void set_target_dist(float value);

  // optional float center_perterb_max = 25 [default = 10];
  inline bool has_center_perterb_max() const;
  inline void clear_center_perterb_max();
  static const int kCenterPerterbMaxFieldNumber = 25;
  inline float center_perterb_max() const;
  inline void set_center_perterb_max(float value);

  // optional float sigma = 26 [default = 7];
  inline bool has_sigma() const;
  inline void clear_sigma();
  static const int kSigmaFieldNumber = 26;
  inline float sigma() const;
  inline void set_sigma(float value);

  // optional float sigma_center = 27 [default = 21];
  inline bool has_sigma_center() const;
  inline void clear_sigma_center();
  static const int kSigmaCenterFieldNumber = 27;
  inline float sigma_center() const;
  inline void set_sigma_center(float value);

  // optional float clahe_tile_size = 28 [default = 8];
  inline bool has_clahe_tile_size() const;
  inline void clear_clahe_tile_size();
  static const int kClaheTileSizeFieldNumber = 28;
  inline float clahe_tile_size() const;
  inline void set_clahe_tile_size(float value);

  // optional float clahe_clip_limit = 29 [default = 4];
  inline bool has_clahe_clip_limit() const;
  inline void clear_clahe_clip_limit();
  static const int kClaheClipLimitFieldNumber = 29;
  inline float clahe_clip_limit() const;
  inline void set_clahe_clip_limit(float value);

  // optional bool do_clahe = 30 [default = false];
  inline bool has_do_clahe() const;
  inline void clear_do_clahe();
  static const int kDoClaheFieldNumber = 30;
  inline bool do_clahe() const;
  inline void set_do_clahe(bool value);

  // optional uint32 num_parts = 31 [default = 14];
  inline bool has_num_parts() const;
  inline void clear_num_parts();
  static const int kNumPartsFieldNumber = 31;
  inline ::google::protobuf::uint32 num_parts() const;
  inline void set_num_parts(::google::protobuf::uint32 value);

  // optional uint32 num_total_augs = 32 [default = 82];
  inline bool has_num_total_augs() const;
  inline void clear_num_total_augs();
  static const int kNumTotalAugsFieldNumber = 32;
  inline ::google::protobuf::uint32 num_total_augs() const;
  inline void set_num_total_augs(::google::protobuf::uint32 value);

  // optional string aug_way = 33 [default = "rand"];
  inline bool has_aug_way() const;
  inline void clear_aug_way();
  static const int kAugWayFieldNumber = 33;
  inline const ::std::string& aug_way() const;
  inline void set_aug_way(const ::std::string& value);
  inline void set_aug_way(const char* value);
  inline void set_aug_way(const char* value, size_t size);
  inline ::std::string* mutable_aug_way();
  inline ::std::string* release_aug_way();
  inline void set_allocated_aug_way(::std::string* aug_way);

  // optional uint32 gray = 34 [default = 0];
  inline bool has_gray() const;
  inline void clear_gray();
  static const int kGrayFieldNumber = 34;
  inline ::google::protobuf::uint32 gray() const;
  inline void set_gray(::google::protobuf::uint32 value);

  // optional uint32 np_in_lmdb = 35 [default = 16];
  inline bool has_np_in_lmdb() const;
  inline void clear_np_in_lmdb();
  static const int kNpInLmdbFieldNumber = 35;
  inline ::google::protobuf::uint32 np_in_lmdb() const;
  inline void set_np_in_lmdb(::google::protobuf::uint32 value);

  // optional bool transform_body_joint = 38 [default = true];
  inline bool has_transform_body_joint() const;
  inline void clear_transform_body_joint();
  static const int kTransformBodyJointFieldNumber = 38;
  inline bool transform_body_joint() const;
  inline void set_transform_body_joint(bool value);

  // optional bool put_gaussian = 39 [default = true];
  inline bool has_put_gaussian() const;
  inline void clear_put_gaussian();
  static const int kPutGaussianFieldNumber = 39;
  inline bool put_gaussian() const;
  inline void set_put_gaussian(bool value);

  // optional bool visualize_label = 40 [default = false];
  inline bool has_visualize_label() const;
  inline void clear_visualize_label();
  static const int kVisualizeLabelFieldNumber = 40;
  inline bool visualize_label() const;
  inline void set_visualize_label(bool value);
 ...
 private:
  ...
  inline void set_has_opaque_coverage();
  inline void clear_has_opaque_coverage();
  inline void set_has_coverage();
  inline void clear_has_coverage();
  ...
  inline void set_has_img_header();
  inline void clear_has_img_header();
  ...
  inline void set_has_clahe_tile_size();
  inline void clear_has_clahe_tile_size();
  inline void set_has_clahe_clip_limit();
  inline void clear_has_clahe_clip_limit();
  inline void set_has_do_clahe();
  inline void clear_has_do_clahe();
  inline void set_has_num_parts();
  inline void clear_has_num_parts();
  inline void set_has_num_total_augs();
  inline void clear_has_num_total_augs();
  inline void set_has_aug_way();
  inline void clear_has_aug_way();
  inline void set_has_gray();
  inline void clear_has_gray();
  inline void set_has_np_in_lmdb();
  inline void clear_has_np_in_lmdb();
  inline void set_has_transform_body_joint();
  inline void clear_has_transform_body_joint();
  inline void set_has_put_gaussian();
  inline void clear_has_put_gaussian();
  inline void set_has_visualize_label();
  inline void clear_has_visualize_label();
  ...
  static ::std::string* _default_coverage_;
  ::std::string* coverage_;
  float flip_prob_;
  bool mirror_;
  bool opaque_coverage_;
  bool visualize_;
  bool force_color_;
  float max_rotate_degree_;
  ::google::protobuf::uint32 crop_size_x_;
  ::google::protobuf::uint32 crop_size_y_;
  float scale_prob_;
  float scale_min_;
  float scale_max_;
  static ::std::string* _default_img_header_;
  ::std::string* img_header_;
  float bbox_norm_factor_;
  float target_dist_;
  float center_perterb_max_;
  float sigma_;
  float sigma_center_;
  float clahe_tile_size_;
  float clahe_clip_limit_;
  ::google::protobuf::uint32 num_parts_;
  bool force_gray_;
  bool do_clahe_;
  bool transform_body_joint_;
  bool put_gaussian_;
  ::google::protobuf::uint32 num_total_augs_;
  static ::std::string* _default_aug_way_;
  ::std::string* aug_way_;
  ::google::protobuf::uint32 gray_;
  ::google::protobuf::uint32 np_in_lmdb_;
  bool visualize_label_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_src_2fcaffe_2fproto_2fcaffe_2eproto();
  friend void protobuf_AssignDesc_src_2fcaffe_2fproto_2fcaffe_2eproto();
  friend void protobuf_ShutdownFile_src_2fcaffe_2fproto_2fcaffe_2eproto();
...
class V1LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.CPMDataParameter cpmdata_param = 99;
  inline bool has_cpmdata_param() const;
  inline void clear_cpmdata_param();
  static const int kCpmdataParamFieldNumber = 99;
  inline const ::caffe::CPMDataParameter& cpmdata_param() const;
  inline ::caffe::CPMDataParameter* mutable_cpmdata_param();
  inline ::caffe::CPMDataParameter* release_cpmdata_param();
  inline void set_allocated_cpmdata_param(::caffe::CPMDataParameter* cpmdata_param);
...
class CPMDataParameter : public ::google::protobuf::Message {
 public:
  CPMDataParameter();
  virtual ~CPMDataParameter();

  CPMDataParameter(const CPMDataParameter& from);

  inline CPMDataParameter& operator=(const CPMDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CPMDataParameter& default_instance();

  void Swap(CPMDataParameter* other);

  // implements Message ----------------------------------------------

  CPMDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CPMDataParameter& from);
  void MergeFrom(const CPMDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef CPMDataParameter_DB DB;
  static const DB LEVELDB = CPMDataParameter_DB_LEVELDB;
  static const DB LMDB = CPMDataParameter_DB_LMDB;
  static inline bool DB_IsValid(int value) {
    return CPMDataParameter_DB_IsValid(value);
  }
  static const DB DB_MIN =
    CPMDataParameter_DB_DB_MIN;
  static const DB DB_MAX =
    CPMDataParameter_DB_DB_MAX;
  static const int DB_ARRAYSIZE =
    CPMDataParameter_DB_DB_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  DB_descriptor() {
    return CPMDataParameter_DB_descriptor();
  }
  static inline const ::std::string& DB_Name(DB value) {
    return CPMDataParameter_DB_Name(value);
  }
  static inline bool DB_Parse(const ::std::string& name,
      DB* value) {
    return CPMDataParameter_DB_Parse(name, value);
  }
  ...
  // optional string lbl_source = 11;
  inline bool has_lbl_source() const;
  inline void clear_lbl_source();
  static const int kLblSourceFieldNumber = 11;
  inline const ::std::string& lbl_source() const;
  inline void set_lbl_source(const ::std::string& value);
  inline void set_lbl_source(const char* value);
  inline void set_lbl_source(const char* value, size_t size);
  inline ::std::string* mutable_lbl_source();
  inline ::std::string* release_lbl_source();
  inline void set_allocated_lbl_source(::std::string* lbl_source);
  ...
  // optional .caffe.CPMDataParameter.DB backend = 8 [default = LEVELDB];
  inline bool has_backend() const;
  inline void clear_backend();
  static const int kBackendFieldNumber = 8;
  inline ::caffe::CPMDataParameter_DB backend() const;
  inline void set_backend(::caffe::CPMDataParameter_DB value);
  ...
  // @@protoc_insertion_point(class_scope:caffe.CPMDataParameter)
 private:
  inline void set_has_source();
  inline void clear_has_source();
  inline void set_has_lbl_source();
  inline void clear_has_lbl_source();
  inline void set_has_batch_size();
  inline void clear_has_batch_size();
  inline void set_has_rand_skip();
  inline void clear_has_rand_skip();
  ...
  void InitAsDefaultInstance();
  static CPMDataParameter* default_instance_;
};
// ===================================================================
...
// optional .caffe.CPMDataParameter cpmdata_param = 999;
inline bool LayerParameter::has_cpmdata_param() const {
  return (_has_bits_[1] & 0x10000000u) != 0;
}
inline void LayerParameter::set_has_cpmdata_param() {
  _has_bits_[1] |= 0x10000000u;
}
inline void LayerParameter::clear_has_cpmdata_param() {
  _has_bits_[1] &= ~0x10000000u;
}
inline void LayerParameter::clear_cpmdata_param() {
  if (cpmdata_param_ != NULL) cpmdata_param_->::caffe::CPMDataParameter::Clear();
  clear_has_cpmdata_param();
}
inline const ::caffe::CPMDataParameter& LayerParameter::cpmdata_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.cpmdata_param)
  return cpmdata_param_ != NULL ? *cpmdata_param_ : *default_instance_->cpmdata_param_;
}
inline ::caffe::CPMDataParameter* LayerParameter::mutable_cpmdata_param() {
  set_has_cpmdata_param();
  if (cpmdata_param_ == NULL) cpmdata_param_ = new ::caffe::CPMDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.cpmdata_param)
  return cpmdata_param_;
}
inline ::caffe::CPMDataParameter* LayerParameter::release_cpmdata_param() {
  clear_has_cpmdata_param();
  ::caffe::CPMDataParameter* temp = cpmdata_param_;
  cpmdata_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_cpmdata_param(::caffe::CPMDataParameter* cpmdata_param) {
  delete cpmdata_param_;
  cpmdata_param_ = cpmdata_param;
  if (cpmdata_param) {
    set_has_cpmdata_param();
  } else {
    clear_has_cpmdata_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.cpmdata_param)
}
...
inline ::google::protobuf::uint32 TransformationParameter::stride() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.stride)
  return stride_;
}
inline void TransformationParameter::set_stride(::google::protobuf::uint32 value) {
  set_has_stride();
  stride_ = value;
...
// optional float scale_cvg = 7 [default = 0.5];
inline bool TransformationParameter::has_scale_cvg() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void TransformationParameter::set_has_scale_cvg() {
  _has_bits_[0] |= 0x00000040u;
}
inline void TransformationParameter::clear_has_scale_cvg() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void TransformationParameter::clear_scale_cvg() {
  scale_cvg_ = 0.5f;
  clear_has_scale_cvg();
}
inline float TransformationParameter::scale_cvg() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.scale_cvg)
  return scale_cvg_;
}
inline void TransformationParameter::set_scale_cvg(float value) {
  set_has_scale_cvg();
  scale_cvg_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.scale_cvg)
}

// optional uint32 max_cvg_len = 8 [default = 50];
inline bool TransformationParameter::has_max_cvg_len() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void TransformationParameter::set_has_max_cvg_len() {
  _has_bits_[0] |= 0x00000080u;
}
inline void TransformationParameter::clear_has_max_cvg_len() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void TransformationParameter::clear_max_cvg_len() {
  max_cvg_len_ = 50u;
  clear_has_max_cvg_len();
}
inline ::google::protobuf::uint32 TransformationParameter::max_cvg_len() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.max_cvg_len)
  return max_cvg_len_;
}
inline void TransformationParameter::set_max_cvg_len(::google::protobuf::uint32 value) {
  set_has_max_cvg_len();
  max_cvg_len_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.max_cvg_len)
}

// optional uint32 min_cvg_len = 9 [default = 50];
inline bool TransformationParameter::has_min_cvg_len() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void TransformationParameter::set_has_min_cvg_len() {
  _has_bits_[0] |= 0x00000100u;
}
inline void TransformationParameter::clear_has_min_cvg_len() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void TransformationParameter::clear_min_cvg_len() {
  min_cvg_len_ = 50u;
  clear_has_min_cvg_len();
}
inline ::google::protobuf::uint32 TransformationParameter::min_cvg_len() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.min_cvg_len)
  return min_cvg_len_;
}
inline void TransformationParameter::set_min_cvg_len(::google::protobuf::uint32 value) {
  set_has_min_cvg_len();
  min_cvg_len_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.min_cvg_len)
}

// optional bool opaque_coverage = 10 [default = true];
inline bool TransformationParameter::has_opaque_coverage() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void TransformationParameter::set_has_opaque_coverage() {
  _has_bits_[0] |= 0x00000200u;
}
inline void TransformationParameter::clear_has_opaque_coverage() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void TransformationParameter::clear_opaque_coverage() {
  opaque_coverage_ = true;
  clear_has_opaque_coverage();
}
inline bool TransformationParameter::opaque_coverage() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.opaque_coverage)
  return opaque_coverage_;
}
inline void TransformationParameter::set_opaque_coverage(bool value) {
  set_has_opaque_coverage();
  opaque_coverage_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.opaque_coverage)
}

// optional string coverage = 11 [default = "gridbox_max"];
inline bool TransformationParameter::has_coverage() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void TransformationParameter::set_has_coverage() {
  _has_bits_[0] |= 0x00000400u;
}
inline void TransformationParameter::clear_has_coverage() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void TransformationParameter::clear_coverage() {
  if (coverage_ != _default_coverage_) {
    coverage_->assign(*_default_coverage_);
  }
  clear_has_coverage();
}
inline const ::std::string& TransformationParameter::coverage() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.coverage)
  return *coverage_;
}
inline void TransformationParameter::set_coverage(const ::std::string& value) {
  set_has_coverage();
  if (coverage_ == _default_coverage_) {
    coverage_ = new ::std::string;
  }
  coverage_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.coverage)
}
inline void TransformationParameter::set_coverage(const char* value) {
  set_has_coverage();
  if (coverage_ == _default_coverage_) {
    coverage_ = new ::std::string;
  }
  coverage_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.TransformationParameter.coverage)
}
inline void TransformationParameter::set_coverage(const char* value, size_t size) {
  set_has_coverage();
  if (coverage_ == _default_coverage_) {
    coverage_ = new ::std::string;
  }
  coverage_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.TransformationParameter.coverage)
}
inline ::std::string* TransformationParameter::mutable_coverage() {
  set_has_coverage();
  if (coverage_ == _default_coverage_) {
    coverage_ = new ::std::string(*_default_coverage_);
  }
  // @@protoc_insertion_point(field_mutable:caffe.TransformationParameter.coverage)
  return coverage_;
}
inline ::std::string* TransformationParameter::release_coverage() {
  clear_has_coverage();
  if (coverage_ == _default_coverage_) {
    return NULL;
  } else {
    ::std::string* temp = coverage_;
    coverage_ = const_cast< ::std::string*>(_default_coverage_);
    return temp;
  }
}
inline void TransformationParameter::set_allocated_coverage(::std::string* coverage) {
  if (coverage_ != _default_coverage_) {
    delete coverage_;
  }
  if (coverage) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.TransformationParameter.coverage)
}

// optional float flip_prob = 12 [default = 0.5];
inline bool TransformationParameter::has_flip_prob() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void TransformationParameter::set_has_flip_prob() {
  _has_bits_[0] |= 0x00000800u;
}
inline void TransformationParameter::clear_has_flip_prob() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void TransformationParameter::clear_flip_prob() {
  flip_prob_ = 0.5f;
  clear_has_flip_prob();
}
inline float TransformationParameter::flip_prob() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.flip_prob)
  return flip_prob_;
}
inline void TransformationParameter::set_flip_prob(float value) {
  set_has_flip_prob();
  flip_prob_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.flip_prob)
}

// optional float max_rotate_degree = 13 [default = 5];
inline bool TransformationParameter::has_max_rotate_degree() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void TransformationParameter::set_has_max_rotate_degree() {
  _has_bits_[0] |= 0x00001000u;
}
inline void TransformationParameter::clear_has_max_rotate_degree() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void TransformationParameter::clear_max_rotate_degree() {
  max_rotate_degree_ = 5;
  clear_has_max_rotate_degree();
}
inline float TransformationParameter::max_rotate_degree() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.max_rotate_degree)
  return max_rotate_degree_;
}
inline void TransformationParameter::set_max_rotate_degree(float value) {
  set_has_max_rotate_degree();
  max_rotate_degree_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.max_rotate_degree)
}

// optional bool visualize = 14 [default = false];
inline bool TransformationParameter::has_visualize() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void TransformationParameter::set_has_visualize() {
  _has_bits_[0] |= 0x00002000u;
}
inline void TransformationParameter::clear_has_visualize() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void TransformationParameter::clear_visualize() {
  visualize_ = false;
  clear_has_visualize();
}
inline bool TransformationParameter::visualize() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.visualize)
  return visualize_;
}
inline void TransformationParameter::set_visualize(bool value) {
  set_has_visualize();
  visualize_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.visualize)
}

// optional uint32 crop_size_x = 15 [default = 368];
inline bool TransformationParameter::has_crop_size_x() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void TransformationParameter::set_has_crop_size_x() {
  _has_bits_[0] |= 0x00004000u;
}
inline void TransformationParameter::clear_has_crop_size_x() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void TransformationParameter::clear_crop_size_x() {
  crop_size_x_ = 368u;
  clear_has_crop_size_x();
}
inline ::google::protobuf::uint32 TransformationParameter::crop_size_x() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.crop_size_x)
  return crop_size_x_;
}
inline void TransformationParameter::set_crop_size_x(::google::protobuf::uint32 value) {
  set_has_crop_size_x();
  crop_size_x_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.crop_size_x)
}

// optional uint32 crop_size_y = 16 [default = 368];
inline bool TransformationParameter::has_crop_size_y() const {
  return (_has_bits_[0] & 0x00008000u) != 0;
}
inline void TransformationParameter::set_has_crop_size_y() {
  _has_bits_[0] |= 0x00008000u;
}
inline void TransformationParameter::clear_has_crop_size_y() {
  _has_bits_[0] &= ~0x00008000u;
}
inline void TransformationParameter::clear_crop_size_y() {
  crop_size_y_ = 368u;
  clear_has_crop_size_y();
}
inline ::google::protobuf::uint32 TransformationParameter::crop_size_y() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.crop_size_y)
  return crop_size_y_;
}
inline void TransformationParameter::set_crop_size_y(::google::protobuf::uint32 value) {
  set_has_crop_size_y();
  crop_size_y_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.crop_size_y)
}

// optional float scale_prob = 17 [default = 0.5];
inline bool TransformationParameter::has_scale_prob() const {
  return (_has_bits_[0] & 0x00010000u) != 0;
}
inline void TransformationParameter::set_has_scale_prob() {
  _has_bits_[0] |= 0x00010000u;
}
inline void TransformationParameter::clear_has_scale_prob() {
  _has_bits_[0] &= ~0x00010000u;
}
inline void TransformationParameter::clear_scale_prob() {
  scale_prob_ = 0.5f;
  clear_has_scale_prob();
}
inline float TransformationParameter::scale_prob() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.scale_prob)
  return scale_prob_;
}
inline void TransformationParameter::set_scale_prob(float value) {
  set_has_scale_prob();
  scale_prob_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.scale_prob)
}
...
// optional float bbox_norm_factor = 20 [default = 300];
inline bool TransformationParameter::has_bbox_norm_factor() const {
  return (_has_bits_[0] & 0x00080000u) != 0;
}
inline void TransformationParameter::set_has_bbox_norm_factor() {
  _has_bits_[0] |= 0x00080000u;
}
inline void TransformationParameter::clear_has_bbox_norm_factor() {
  _has_bits_[0] &= ~0x00080000u;
}
inline void TransformationParameter::clear_bbox_norm_factor() {
  bbox_norm_factor_ = 300;
  clear_has_bbox_norm_factor();
}
inline float TransformationParameter::bbox_norm_factor() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.bbox_norm_factor)
  return bbox_norm_factor_;
}
inline void TransformationParameter::set_bbox_norm_factor(float value) {
  set_has_bbox_norm_factor();
  bbox_norm_factor_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.bbox_norm_factor)
}

// optional string img_header = 21 [default = "."];
inline bool TransformationParameter::has_img_header() const {
  return (_has_bits_[0] & 0x00100000u) != 0;
}
inline void TransformationParameter::set_has_img_header() {
  _has_bits_[0] |= 0x00100000u;
}
inline void TransformationParameter::clear_has_img_header() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void TransformationParameter::clear_img_header() {
  if (img_header_ != _default_img_header_) {
    img_header_->assign(*_default_img_header_);
  }
  clear_has_img_header();
}
inline const ::std::string& TransformationParameter::img_header() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.img_header)
  return *img_header_;
}
inline void TransformationParameter::set_img_header(const ::std::string& value) {
  set_has_img_header();
  if (img_header_ == _default_img_header_) {
    img_header_ = new ::std::string;
  }
  img_header_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.img_header)
}
inline void TransformationParameter::set_img_header(const char* value) {
  set_has_img_header();
  if (img_header_ == _default_img_header_) {
    img_header_ = new ::std::string;
  }
  img_header_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.TransformationParameter.img_header)
}
inline void TransformationParameter::set_img_header(const char* value, size_t size) {
  set_has_img_header();
  if (img_header_ == _default_img_header_) {
    img_header_ = new ::std::string;
  }
  img_header_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.TransformationParameter.img_header)
}
inline ::std::string* TransformationParameter::mutable_img_header() {
  set_has_img_header();
  if (img_header_ == _default_img_header_) {
    img_header_ = new ::std::string(*_default_img_header_);
  }
  // @@protoc_insertion_point(field_mutable:caffe.TransformationParameter.img_header)
  return img_header_;
}
inline ::std::string* TransformationParameter::release_img_header() {
  clear_has_img_header();
  if (img_header_ == _default_img_header_) {
    return NULL;
  } else {
    ::std::string* temp = img_header_;
    img_header_ = const_cast< ::std::string*>(_default_img_header_);
    return temp;
  }
}
inline void TransformationParameter::set_allocated_img_header(::std::string* img_header) {
  if (img_header_ != _default_img_header_) {
    delete img_header_;
  }
  if (img_header) {
    set_has_img_header();
    img_header_ = img_header;
  } else {
    clear_has_img_header();
    img_header_ = const_cast< ::std::string*>(_default_img_header_);
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.TransformationParameter.img_header)
}
...
// optional float target_dist = 24 [default = 1];
inline bool TransformationParameter::has_target_dist() const {
  return (_has_bits_[0] & 0x00800000u) != 0;
}
inline void TransformationParameter::set_has_target_dist() {
  _has_bits_[0] |= 0x00800000u;
}
inline void TransformationParameter::clear_has_target_dist() {
  _has_bits_[0] &= ~0x00800000u;
}
inline void TransformationParameter::clear_target_dist() {
  target_dist_ = 1;
  clear_has_target_dist();
}
inline float TransformationParameter::target_dist() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.target_dist)
  return target_dist_;
}
inline void TransformationParameter::set_target_dist(float value) {
  set_has_target_dist();
  target_dist_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.target_dist)
}

// optional float center_perterb_max = 25 [default = 10];
inline bool TransformationParameter::has_center_perterb_max() const {
  return (_has_bits_[0] & 0x01000000u) != 0;
}
inline void TransformationParameter::set_has_center_perterb_max() {
  _has_bits_[0] |= 0x01000000u;
}
inline void TransformationParameter::clear_has_center_perterb_max() {
  _has_bits_[0] &= ~0x01000000u;
}
inline void TransformationParameter::clear_center_perterb_max() {
  center_perterb_max_ = 10;
  clear_has_center_perterb_max();
}
inline float TransformationParameter::center_perterb_max() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.center_perterb_max)
  return center_perterb_max_;
}
inline void TransformationParameter::set_center_perterb_max(float value) {
  set_has_center_perterb_max();
  center_perterb_max_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.center_perterb_max)
}

// optional float sigma = 26 [default = 7];
inline bool TransformationParameter::has_sigma() const {
  return (_has_bits_[0] & 0x02000000u) != 0;
}
inline void TransformationParameter::set_has_sigma() {
  _has_bits_[0] |= 0x02000000u;
}
inline void TransformationParameter::clear_has_sigma() {
  _has_bits_[0] &= ~0x02000000u;
}
inline void TransformationParameter::clear_sigma() {
  sigma_ = 7;
  clear_has_sigma();
}
inline float TransformationParameter::sigma() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.sigma)
  return sigma_;
}
inline void TransformationParameter::set_sigma(float value) {
  set_has_sigma();
  sigma_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.sigma)
}

// optional float sigma_center = 27 [default = 21];
inline bool TransformationParameter::has_sigma_center() const {
  return (_has_bits_[0] & 0x04000000u) != 0;
}
inline void TransformationParameter::set_has_sigma_center() {
  _has_bits_[0] |= 0x04000000u;
}
inline void TransformationParameter::clear_has_sigma_center() {
  _has_bits_[0] &= ~0x04000000u;
}
inline void TransformationParameter::clear_sigma_center() {
  sigma_center_ = 21;
  clear_has_sigma_center();
}
inline float TransformationParameter::sigma_center() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.sigma_center)
  return sigma_center_;
}
inline void TransformationParameter::set_sigma_center(float value) {
  set_has_sigma_center();
  sigma_center_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.sigma_center)
}

// optional float clahe_tile_size = 28 [default = 8];
inline bool TransformationParameter::has_clahe_tile_size() const {
  return (_has_bits_[0] & 0x08000000u) != 0;
}
inline void TransformationParameter::set_has_clahe_tile_size() {
  _has_bits_[0] |= 0x08000000u;
}
inline void TransformationParameter::clear_has_clahe_tile_size() {
  _has_bits_[0] &= ~0x08000000u;
}
inline void TransformationParameter::clear_clahe_tile_size() {
  clahe_tile_size_ = 8;
  clear_has_clahe_tile_size();
}
inline float TransformationParameter::clahe_tile_size() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.clahe_tile_size)
  return clahe_tile_size_;
}
inline void TransformationParameter::set_clahe_tile_size(float value) {
  set_has_clahe_tile_size();
  clahe_tile_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.clahe_tile_size)
}

// optional float clahe_clip_limit = 29 [default = 4];
inline bool TransformationParameter::has_clahe_clip_limit() const {
  return (_has_bits_[0] & 0x10000000u) != 0;
}
inline void TransformationParameter::set_has_clahe_clip_limit() {
  _has_bits_[0] |= 0x10000000u;
}
inline void TransformationParameter::clear_has_clahe_clip_limit() {
  _has_bits_[0] &= ~0x10000000u;
}
inline void TransformationParameter::clear_clahe_clip_limit() {
  clahe_clip_limit_ = 4;
  clear_has_clahe_clip_limit();
}
inline float TransformationParameter::clahe_clip_limit() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.clahe_clip_limit)
  return clahe_clip_limit_;
}
inline void TransformationParameter::set_clahe_clip_limit(float value) {
  set_has_clahe_clip_limit();
  clahe_clip_limit_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.clahe_clip_limit)
}

// optional bool do_clahe = 30 [default = false];
inline bool TransformationParameter::has_do_clahe() const {
  return (_has_bits_[0] & 0x20000000u) != 0;
}
inline void TransformationParameter::set_has_do_clahe() {
  _has_bits_[0] |= 0x20000000u;
}
inline void TransformationParameter::clear_has_do_clahe() {
  _has_bits_[0] &= ~0x20000000u;
}
inline void TransformationParameter::clear_do_clahe() {
  do_clahe_ = false;
  clear_has_do_clahe();
}
inline bool TransformationParameter::do_clahe() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.do_clahe)
  return do_clahe_;
}
inline void TransformationParameter::set_do_clahe(bool value) {
  set_has_do_clahe();
  do_clahe_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.do_clahe)
}

// optional uint32 num_parts = 31 [default = 14];
inline bool TransformationParameter::has_num_parts() const {
  return (_has_bits_[0] & 0x40000000u) != 0;
}
inline void TransformationParameter::set_has_num_parts() {
  _has_bits_[0] |= 0x40000000u;
}
inline void TransformationParameter::clear_has_num_parts() {
  _has_bits_[0] &= ~0x40000000u;
}
inline void TransformationParameter::clear_num_parts() {
  num_parts_ = 14u;
  clear_has_num_parts();
}
inline ::google::protobuf::uint32 TransformationParameter::num_parts() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.num_parts)
  return num_parts_;
}
inline void TransformationParameter::set_num_parts(::google::protobuf::uint32 value) {
  set_has_num_parts();
  num_parts_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.num_parts)
}

// optional uint32 num_total_augs = 32 [default = 82];
inline bool TransformationParameter::has_num_total_augs() const {
  return (_has_bits_[0] & 0x80000000u) != 0;
}
inline void TransformationParameter::set_has_num_total_augs() {
  _has_bits_[0] |= 0x80000000u;
}
inline void TransformationParameter::clear_has_num_total_augs() {
  _has_bits_[0] &= ~0x80000000u;
}
inline void TransformationParameter::clear_num_total_augs() {
  num_total_augs_ = 82u;
  clear_has_num_total_augs();
}
inline ::google::protobuf::uint32 TransformationParameter::num_total_augs() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.num_total_augs)
  return num_total_augs_;
}
inline void TransformationParameter::set_num_total_augs(::google::protobuf::uint32 value) {
  set_has_num_total_augs();
  num_total_augs_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.num_total_augs)
}

// optional string aug_way = 33 [default = "rand"];
inline bool TransformationParameter::has_aug_way() const {
  return (_has_bits_[1] & 0x00000001u) != 0;
}
inline void TransformationParameter::set_has_aug_way() {
  _has_bits_[1] |= 0x00000001u;
}
inline void TransformationParameter::clear_has_aug_way() {
  _has_bits_[1] &= ~0x00000001u;
}
inline void TransformationParameter::clear_aug_way() {
  if (aug_way_ != _default_aug_way_) {
    aug_way_->assign(*_default_aug_way_);
  }
  clear_has_aug_way();
}
inline const ::std::string& TransformationParameter::aug_way() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.aug_way)
  return *aug_way_;
}
inline void TransformationParameter::set_aug_way(const ::std::string& value) {
  set_has_aug_way();
  if (aug_way_ == _default_aug_way_) {
    aug_way_ = new ::std::string;
  }
  aug_way_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.aug_way)
}
inline void TransformationParameter::set_aug_way(const char* value) {
  set_has_aug_way();
  if (aug_way_ == _default_aug_way_) {
    aug_way_ = new ::std::string;
  }
  aug_way_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.TransformationParameter.aug_way)
}
inline void TransformationParameter::set_aug_way(const char* value, size_t size) {
  set_has_aug_way();
  if (aug_way_ == _default_aug_way_) {
    aug_way_ = new ::std::string;
  }
  aug_way_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.TransformationParameter.aug_way)
}
inline ::std::string* TransformationParameter::mutable_aug_way() {
  set_has_aug_way();
  if (aug_way_ == _default_aug_way_) {
    aug_way_ = new ::std::string(*_default_aug_way_);
  }
  // @@protoc_insertion_point(field_mutable:caffe.TransformationParameter.aug_way)
  return aug_way_;
}
inline ::std::string* TransformationParameter::release_aug_way() {
  clear_has_aug_way();
  if (aug_way_ == _default_aug_way_) {
    return NULL;
  } else {
    ::std::string* temp = aug_way_;
    aug_way_ = const_cast< ::std::string*>(_default_aug_way_);
    return temp;
  }
}
inline void TransformationParameter::set_allocated_aug_way(::std::string* aug_way) {
  if (aug_way_ != _default_aug_way_) {
    delete aug_way_;
  }
  if (aug_way) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.TransformationParameter.aug_way)
}

// optional uint32 gray = 34 [default = 0];
inline bool TransformationParameter::has_gray() const {
  return (_has_bits_[1] & 0x00000002u) != 0;
}
inline void TransformationParameter::set_has_gray() {
  _has_bits_[1] |= 0x00000002u;
}
inline void TransformationParameter::clear_has_gray() {
  _has_bits_[1] &= ~0x00000002u;
}
inline void TransformationParameter::clear_gray() {
  gray_ = 0u;
  clear_has_gray();
}
inline ::google::protobuf::uint32 TransformationParameter::gray() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.gray)
  return gray_;
}
inline void TransformationParameter::set_gray(::google::protobuf::uint32 value) {
  set_has_gray();
  gray_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.gray)
}

// optional uint32 np_in_lmdb = 35 [default = 16];
inline bool TransformationParameter::has_np_in_lmdb() const {
  return (_has_bits_[1] & 0x00000004u) != 0;
}
inline void TransformationParameter::set_has_np_in_lmdb() {
  _has_bits_[1] |= 0x00000004u;
}
inline void TransformationParameter::clear_has_np_in_lmdb() {
  _has_bits_[1] &= ~0x00000004u;
}
inline void TransformationParameter::clear_np_in_lmdb() {
  np_in_lmdb_ = 16u;
  clear_has_np_in_lmdb();
}
inline ::google::protobuf::uint32 TransformationParameter::np_in_lmdb() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.np_in_lmdb)
  return np_in_lmdb_;
}
inline void TransformationParameter::set_np_in_lmdb(::google::protobuf::uint32 value) {
  set_has_np_in_lmdb();
  np_in_lmdb_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.np_in_lmdb)
}

// optional bool transform_body_joint = 38 [default = true];
inline bool TransformationParameter::has_transform_body_joint() const {
  return (_has_bits_[1] & 0x00000008u) != 0;
}
inline void TransformationParameter::set_has_transform_body_joint() {
  _has_bits_[1] |= 0x00000008u;
}
inline void TransformationParameter::clear_has_transform_body_joint() {
  _has_bits_[1] &= ~0x00000008u;
}
inline void TransformationParameter::clear_transform_body_joint() {
  transform_body_joint_ = true;
  clear_has_transform_body_joint();
}
inline bool TransformationParameter::transform_body_joint() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.transform_body_joint)
  return transform_body_joint_;
}
inline void TransformationParameter::set_transform_body_joint(bool value) {
  set_has_transform_body_joint();
  transform_body_joint_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.transform_body_joint)
}

// optional bool put_gaussian = 39 [default = true];
inline bool TransformationParameter::has_put_gaussian() const {
  return (_has_bits_[1] & 0x00000010u) != 0;
}
inline void TransformationParameter::set_has_put_gaussian() {
  _has_bits_[1] |= 0x00000010u;
}
inline void TransformationParameter::clear_has_put_gaussian() {
  _has_bits_[1] &= ~0x00000010u;
}
inline void TransformationParameter::clear_put_gaussian() {
  put_gaussian_ = true;
  clear_has_put_gaussian();
}
inline bool TransformationParameter::put_gaussian() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.put_gaussian)
  return put_gaussian_;
}
inline void TransformationParameter::set_put_gaussian(bool value) {
  set_has_put_gaussian();
  put_gaussian_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.put_gaussian)
}

// optional bool visualize_label = 40 [default = false];
inline bool TransformationParameter::has_visualize_label() const {
  return (_has_bits_[1] & 0x00000020u) != 0;
}
inline void TransformationParameter::set_has_visualize_label() {
  _has_bits_[1] |= 0x00000020u;
}
inline void TransformationParameter::clear_has_visualize_label() {
  _has_bits_[1] &= ~0x00000020u;
}
inline void TransformationParameter::clear_visualize_label() {
  visualize_label_ = false;
  clear_has_visualize_label();
}
inline bool TransformationParameter::visualize_label() const {
  // @@protoc_insertion_point(field_get:caffe.TransformationParameter.visualize_label)
  return visualize_label_;
}
inline void TransformationParameter::set_visualize_label(bool value) {
  set_has_visualize_label();
  visualize_label_ = value;
  // @@protoc_insertion_point(field_set:caffe.TransformationParameter.visualize_label)
}
...
// optional .caffe.CPMDataParameter cpmdata_param = 99;
inline bool V1LayerParameter::has_cpmdata_param() const {
  return (_has_bits_[1] & 0x00000800u) != 0;
}
inline void V1LayerParameter::set_has_cpmdata_param() {
  _has_bits_[1] |= 0x00000800u;
}
inline void V1LayerParameter::clear_has_cpmdata_param() {
  _has_bits_[1] &= ~0x00000800u;
}
inline void V1LayerParameter::clear_cpmdata_param() {
  if (cpmdata_param_ != NULL) cpmdata_param_->::caffe::CPMDataParameter::Clear();
  clear_has_cpmdata_param();
}
inline const ::caffe::CPMDataParameter& V1LayerParameter::cpmdata_param() const {
  // @@protoc_insertion_point(field_get:caffe.V1LayerParameter.cpmdata_param)
  return cpmdata_param_ != NULL ? *cpmdata_param_ : *default_instance_->cpmdata_param_;
}
inline ::caffe::CPMDataParameter* V1LayerParameter::mutable_cpmdata_param() {
  set_has_cpmdata_param();
  if (cpmdata_param_ == NULL) cpmdata_param_ = new ::caffe::CPMDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.V1LayerParameter.cpmdata_param)
  return cpmdata_param_;
}
inline ::caffe::CPMDataParameter* V1LayerParameter::release_cpmdata_param() {
  clear_has_cpmdata_param();
  ::caffe::CPMDataParameter* temp = cpmdata_param_;
  cpmdata_param_ = NULL;
  return temp;
}
inline void V1LayerParameter::set_allocated_cpmdata_param(::caffe::CPMDataParameter* cpmdata_param) {
  delete cpmdata_param_;
  cpmdata_param_ = cpmdata_param;
  if (cpmdata_param) {
    set_has_cpmdata_param();
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.V1LayerParameter.cpmdata_param)
}
...
// optional string source = 1;
inline bool CPMDataParameter::has_source() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CPMDataParameter::set_has_source() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CPMDataParameter::clear_has_source() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CPMDataParameter::clear_source() {
  if (source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_->clear();
  }
  clear_has_source();
}
inline const ::std::string& CPMDataParameter::source() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.source)
  return *source_;
}
inline void CPMDataParameter::set_source(const ::std::string& value) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  source_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.source)
}
inline void CPMDataParameter::set_source(const char* value) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  source_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.CPMDataParameter.source)
}
inline void CPMDataParameter::set_source(const char* value, size_t size) {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  source_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.CPMDataParameter.source)
}
inline ::std::string* CPMDataParameter::mutable_source() {
  set_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    source_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.CPMDataParameter.source)
  return source_;
}
inline ::std::string* CPMDataParameter::release_source() {
  clear_has_source();
  if (source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void CPMDataParameter::set_allocated_source(::std::string* source) {
  if (source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete source_;
  }
  if (source) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.CPMDataParameter.source)
}

// optional string lbl_source = 11;
inline bool CPMDataParameter::has_lbl_source() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void CPMDataParameter::set_has_lbl_source() {
  _has_bits_[0] |= 0x00000002u;
}
inline void CPMDataParameter::clear_has_lbl_source() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void CPMDataParameter::clear_lbl_source() {
  if (lbl_source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    lbl_source_->clear();
  }
  clear_has_lbl_source();
}
inline const ::std::string& CPMDataParameter::lbl_source() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.lbl_source)
  return *lbl_source_;
}
inline void CPMDataParameter::set_lbl_source(const ::std::string& value) {
  set_has_lbl_source();
  if (lbl_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    lbl_source_ = new ::std::string;
  }
  lbl_source_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.lbl_source)
}
inline void CPMDataParameter::set_lbl_source(const char* value) {
  set_has_lbl_source();
  if (lbl_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    lbl_source_ = new ::std::string;
  }
  lbl_source_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.CPMDataParameter.lbl_source)
}
inline void CPMDataParameter::set_lbl_source(const char* value, size_t size) {
  set_has_lbl_source();
  if (lbl_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    lbl_source_ = new ::std::string;
  }
  lbl_source_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.CPMDataParameter.lbl_source)
}
inline ::std::string* CPMDataParameter::mutable_lbl_source() {
  set_has_lbl_source();
  if (lbl_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    lbl_source_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.CPMDataParameter.lbl_source)
  return lbl_source_;
}
inline ::std::string* CPMDataParameter::release_lbl_source() {
  clear_has_lbl_source();
  if (lbl_source_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = lbl_source_;
    lbl_source_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void CPMDataParameter::set_allocated_lbl_source(::std::string* lbl_source) {
  if (lbl_source_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete lbl_source_;
  }
  if (lbl_source) {
    set_has_lbl_source();
    lbl_source_ = lbl_source;
  } else {
    clear_has_lbl_source();
    lbl_source_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.CPMDataParameter.lbl_source)
}

// optional uint32 batch_size = 4;
inline bool CPMDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void CPMDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000004u;
}
inline void CPMDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void CPMDataParameter::clear_batch_size() {
  batch_size_ = 0u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 CPMDataParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.batch_size)
  return batch_size_;
}
inline void CPMDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.batch_size)
}

// optional uint32 rand_skip = 7 [default = 0];
inline bool CPMDataParameter::has_rand_skip() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void CPMDataParameter::set_has_rand_skip() {
  _has_bits_[0] |= 0x00000008u;
}
inline void CPMDataParameter::clear_has_rand_skip() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void CPMDataParameter::clear_rand_skip() {
  rand_skip_ = 0u;
  clear_has_rand_skip();
}
inline ::google::protobuf::uint32 CPMDataParameter::rand_skip() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.rand_skip)
  return rand_skip_;
}
inline void CPMDataParameter::set_rand_skip(::google::protobuf::uint32 value) {
  set_has_rand_skip();
  rand_skip_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.rand_skip)
}

// optional .caffe.CPMDataParameter.DB backend = 8 [default = LEVELDB];
inline bool CPMDataParameter::has_backend() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void CPMDataParameter::set_has_backend() {
  _has_bits_[0] |= 0x00000010u;
}
inline void CPMDataParameter::clear_has_backend() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void CPMDataParameter::clear_backend() {
  backend_ = 0;
  clear_has_backend();
}
inline ::caffe::CPMDataParameter_DB CPMDataParameter::backend() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.backend)
  return static_cast< ::caffe::CPMDataParameter_DB >(backend_);
}
inline void CPMDataParameter::set_backend(::caffe::CPMDataParameter_DB value) {
  assert(::caffe::CPMDataParameter_DB_IsValid(value));
  set_has_backend();
  backend_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.backend)
}

// optional float scale = 2 [default = 1];
inline bool CPMDataParameter::has_scale() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void CPMDataParameter::set_has_scale() {
  _has_bits_[0] |= 0x00000020u;
}
inline void CPMDataParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void CPMDataParameter::clear_scale() {
  scale_ = 1;
  clear_has_scale();
}
inline float CPMDataParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.scale)
  return scale_;
}
inline void CPMDataParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.scale)
}

// optional string mean_file = 3;
inline bool CPMDataParameter::has_mean_file() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void CPMDataParameter::set_has_mean_file() {
  _has_bits_[0] |= 0x00000040u;
}
inline void CPMDataParameter::clear_has_mean_file() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void CPMDataParameter::clear_mean_file() {
  if (mean_file_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_->clear();
  }
  clear_has_mean_file();
}
inline const ::std::string& CPMDataParameter::mean_file() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.mean_file)
  return *mean_file_;
}
inline void CPMDataParameter::set_mean_file(const ::std::string& value) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  mean_file_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.mean_file)
}
inline void CPMDataParameter::set_mean_file(const char* value) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  mean_file_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.CPMDataParameter.mean_file)
}
inline void CPMDataParameter::set_mean_file(const char* value, size_t size) {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  mean_file_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.CPMDataParameter.mean_file)
}
inline ::std::string* CPMDataParameter::mutable_mean_file() {
  set_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    mean_file_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.CPMDataParameter.mean_file)
  return mean_file_;
}
inline ::std::string* CPMDataParameter::release_mean_file() {
  clear_has_mean_file();
  if (mean_file_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void CPMDataParameter::set_allocated_mean_file(::std::string* mean_file) {
  if (mean_file_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete mean_file_;
  }
  if (mean_file) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.CPMDataParameter.mean_file)
}

// optional uint32 crop_size = 5 [default = 0];
inline bool CPMDataParameter::has_crop_size() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void CPMDataParameter::set_has_crop_size() {
  _has_bits_[0] |= 0x00000080u;
}
inline void CPMDataParameter::clear_has_crop_size() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void CPMDataParameter::clear_crop_size() {
  crop_size_ = 0u;
  clear_has_crop_size();
}
inline ::google::protobuf::uint32 CPMDataParameter::crop_size() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.crop_size)
  return crop_size_;
}
inline void CPMDataParameter::set_crop_size(::google::protobuf::uint32 value) {
  set_has_crop_size();
  crop_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.crop_size)
}

// optional bool mirror = 6 [default = false];
inline bool CPMDataParameter::has_mirror() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void CPMDataParameter::set_has_mirror() {
  _has_bits_[0] |= 0x00000100u;
}
inline void CPMDataParameter::clear_has_mirror() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void CPMDataParameter::clear_mirror() {
  mirror_ = false;
  clear_has_mirror();
}
inline bool CPMDataParameter::mirror() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.mirror)
  return mirror_;
}
inline void CPMDataParameter::set_mirror(bool value) {
  set_has_mirror();
  mirror_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.mirror)
}

// optional bool force_encoded_color = 9 [default = false];
inline bool CPMDataParameter::has_force_encoded_color() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void CPMDataParameter::set_has_force_encoded_color() {
  _has_bits_[0] |= 0x00000200u;
}
inline void CPMDataParameter::clear_has_force_encoded_color() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void CPMDataParameter::clear_force_encoded_color() {
  force_encoded_color_ = false;
  clear_has_force_encoded_color();
}
inline bool CPMDataParameter::force_encoded_color() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.force_encoded_color)
  return force_encoded_color_;
}
inline void CPMDataParameter::set_force_encoded_color(bool value) {
  set_has_force_encoded_color();
  force_encoded_color_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.force_encoded_color)
}

// optional uint32 prefetch = 10 [default = 4];
inline bool CPMDataParameter::has_prefetch() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void CPMDataParameter::set_has_prefetch() {
  _has_bits_[0] |= 0x00000400u;
}
inline void CPMDataParameter::clear_has_prefetch() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void CPMDataParameter::clear_prefetch() {
  prefetch_ = 4u;
  clear_has_prefetch();
}
inline ::google::protobuf::uint32 CPMDataParameter::prefetch() const {
  // @@protoc_insertion_point(field_get:caffe.CPMDataParameter.prefetch)
  return prefetch_;
}
inline void CPMDataParameter::set_prefetch(::google::protobuf::uint32 value) {
  set_has_prefetch();
  prefetch_ = value;
  // @@protoc_insertion_point(field_set:caffe.CPMDataParameter.prefetch)
}
...
template <> struct is_proto_enum< ::caffe::CPMDataParameter_DB> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::CPMDataParameter_DB>() {
  return ::caffe::CPMDataParameter_DB_descriptor();
}
